...
def load_data(dataset_dir, subject_n=32, img_size=(8, 9, 8), number_of_inputs=1,   # 根据输入特征维度修改imag_size
    ...
    samples_number_per_subject = int(frames_per_subject / number_of_inputs)  # tested only for [1...6] range   ssh -p 40539 root@region-45.autodl.pro
    ...
    # print("y_a_all_subject shape", y_a_all_subject.shape)
