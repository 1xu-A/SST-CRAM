...
from eegemotion.train_leaveoneout import train
import numpy as np
from eegemotion.utils import print_results

# specify dataset and model dirs
# dataset_dir = "/root/autodl-tmp/DE+PSD32/"  # path of the folder with PSD_s and DE_s files
dataset_dir = "\\DEAP\\DE+PSD89\\"
# model_dir = "/root/autodl-tmp/MT_CNN/"  # path where the model and metrics will be stored
model_dir = "\\DEAP\\SST-CRAM\\"
# metrics_dir = "/root/autodl-tmp/MT_CNN/"  # path to the folder were all metrics will be stored
metrics_dir ="\\DEAP\\MT_metrics\\"
img_size = img_rows, img_cols, num_chan = 8, 9, 8  # matrix shape of input data  8,9,8  ssh -p 53157 root@region-45.autodl.pro
...
dropout_rate = 0.2
model_name = 'SST-CRAM'  # will be a filename part
...
epochs_n = 2  # maximum number of epochs
verbose = 0  # 0, 1 or 2
